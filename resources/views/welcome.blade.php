...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="#">Antara Custom</a>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        ...
        @endguest
	<div class="content">
		<h1 class="title">Antara Custom</h1>
		<h3>The Best Kit for Any Solutions</h3>
	</div>
	<div class="container">
		<div class="products">
